...
DATA_PATH = os.path.join(PROJECT_ROOT, "crop_model", "data", "combined", "final_crop_dataset.csv")
MODEL_DIR = os.path.join(PROJECT_ROOT, "crop_model", "models")
REPORT_DIR = os.path.join(PROJECT_ROOT, "crop_model", "reports")
