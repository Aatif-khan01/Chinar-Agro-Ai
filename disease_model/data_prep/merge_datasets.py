...
plantvillage = r".\disease_model\data\plantvillage"

# New Plant Diseases Dataset
newdataset = r".\disease_model\data\newdataset\New Plant Diseases Dataset(Augmented)\train"

# Rice Dataset
rice = r".\disease_model\data\archive (1)\Rice Leaf Bacterial and Fungal Disease Dataset\Augmented\Augmented Images"

# Cassava Dataset
cassava = r".\disease_model\data\cassava-leaf-disease-classification\train_images"
cassava_csv = r".\disease_model\data\cassava-leaf-disease-classification\train.csv"

# Combined Dataset
combined = r".\disease_model\data\combined"
