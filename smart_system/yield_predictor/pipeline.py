...
class PlantDoctorPipeline:
    ...
    def __init__(
        ...
        # -- CLIP open-world fallback (safe init - disabled by default to save 350MB RAM) --
        self._clip_model = None
        if os.getenv("ENABLE_CLIP", "false").lower() in ("true", "1", "yes"):
            try:
            ...
            logger.info("CLIP disabled to conserve memory (ENABLE_CLIP=false)")
